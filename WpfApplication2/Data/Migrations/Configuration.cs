namespace Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Data.BrokerDbContext>
    {
        ...
        protected override void Seed(Data.BrokerDbContext context)
        {
            ...
            {
                DueDate = policy1.EndDate,
                DateOfPayment = policy1.EndDate,
                Premium = 23.2m,
                Tax = 6.02m,
                Price = 29m,
                FinalPrice = 34.21m,
            ...
            {
                DueDate = policy2.EndDate,
                DateOfPayment = policy2.EndDate,
                Premium = 23.2m,
                Tax = 6.02m,
                Price = 29m,
                FinalPrice = 34.21m,
            ...
            {
                DueDate = policy3.EndDate,
                DateOfPayment = policy3.EndDate,
                Premium = 23.2m,
                Tax = 6.02m,
                Price = 29m,
                FinalPrice = 34.21m,
