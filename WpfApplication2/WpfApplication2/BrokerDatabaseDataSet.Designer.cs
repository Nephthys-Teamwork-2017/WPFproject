...
namespace WpfApplication2 {
    ...
    public partial class BrokerDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string Code, string Name, bool IsDeleted) {
...
namespace WpfApplication2.BrokerDatabaseDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ([IsDeleted] = @Ori" +
                "ginal_IsDeleted))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([Code], [Name], [IsDeleted]) VALUES (@Code, @Name, " +
                "@IsDeleted);\r\nSELECT Id, Code, Name, IsDeleted FROM Products WHERE (Id = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [Code] = @Code, [Name] = @Name, [IsDeleted] = @IsDele" +
                "ted WHERE (([Id] = @Original_Id) AND ([IsDeleted] = @Original_IsDeleted));\r\nSELE" +
                "CT Id, Code, Name, IsDeleted FROM Products WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WpfApplication2.Properties.Settings.Default.BrokerDatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Code, Name, IsDeleted FROM dbo.Products";
        ...
        public virtual int Insert(string Code, string Name, bool IsDeleted) {
            if ((Code == null)) {
        ...
        public virtual int Update(string Code, string Name, bool IsDeleted, int Original_Id, bool Original_IsDeleted, int Id) {
            if ((Code == null)) {
                throw new global::System.ArgumentNullException("Code");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Code, string Name, bool IsDeleted, int Original_Id, bool Original_IsDeleted) {
            return this.Update(Code, Name, IsDeleted, Original_Id, Original_IsDeleted, Original_Id);
        }
    }
